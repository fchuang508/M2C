...
This repository holds two kinds of public project pages: **quotations** (报价单) and **co-creation covenants / contracts** (共创契约). Each project lives in its own numbered folder and exposes `index.html` as its stable public URL.
...
- `03-coart-create-promotion/` — Co-Art Create Promotion · 艺术共创营系列宣传框架 · 共创契约（会议 308247877）
